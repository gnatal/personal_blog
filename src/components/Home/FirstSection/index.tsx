      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
            <img className="block mx-auto" src="wrexa-assets/images/graphic-purple.png" alt="" />
          </div>
          <div className="w-full lg:w-1/2 px-4">
            <div className="max-w-lg mx-auto">
              ...
              <div className="mb-16">
                <a className="inline-block mr-6 text-indigo-500 hover:text-indigo-600" href="!#">#interiodesign</a>
                <a className="inline-block mr-6 text-indigo-500 hover:text-indigo-600" href="!#">#design</a>
                <a className="inline-block text-indigo-500 hover:text-indigo-600" href="!#">#application</a>
              </div>
